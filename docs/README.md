...
2. [v1.5 implementation plan](implementation/v1.5/README.md): archived reference for staged implementation; the current request and tracker set active scope.
